...
parser.add_argument("--valid_dir", type=str, default="/root/simple_hao/dataset", help="thr dir of train data")
...
parser.add_argument("--test_dir", type=str, default="/root/simple_hao/dataset", help="thr dir of train data")
...
parser.add_argument('--batch_size', type=int, default=45, help='input batch size for training')
parser.add_argument("--valid_batch_size", type=int, default=45, help="input batch size of valid")
